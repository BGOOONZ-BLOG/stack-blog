  ...
  render() {
    let display_posts =
        ...
        toStyleObj('background-image: url(\'' +
                   withPrefix(_.get(this.props, 'pageContext.frontmatter.image',
                                    null)) +
                   '\')')}/>
                )}
              ...
              <div className="inner-md outer">
                <div className="post-feed">
                  ...
                  <article key={post_idx} className="post">
                    ...
                    <Link className="post-thumbnail" to={withPrefix(_.get(post, 'url', null))}><img src={withPrefix(_.get(post, 'frontmatter.thumb_image', null))} alt={_.get(this.props, 'pageContext.frontmatter.thumb_image_alt', null)} />
             </Link>
                    )}
                    <header className="post-header">
                      ...
                      <h2 className="post-title line-left"><Link to={withPrefix(_.get(post, 'url', null))} rel="bookmark">{_.get(post, 'frontmatter.title', null)}</Link>
             </h2>
                    </header>{
                 _.get(post, 'frontmatter.excerpt', null) &&
                 (<React.Fragment><p className = "post-excerpt">{
                     _.get(post, 'frontmatter.excerpt', null)}<
                     /p>
